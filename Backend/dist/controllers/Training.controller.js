...
exports.deleteTraining = exports.updateTraining = exports.getAllTrainings = exports.getTrainingById = exports.createTraining = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
// Create Training
const createTraining = async (req, res) => {
    const { employeeId, trainerType, // "Internal" | "External"
    trainerName, mode, // "Online" | "Offline"
    trainingTopic, startDate, endDate, certificate, // "Required" | "NotRequired"
    departmentId, departmentName, managerId } = req.body;
    try {
